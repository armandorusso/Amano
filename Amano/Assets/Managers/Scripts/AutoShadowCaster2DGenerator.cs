/*
 * This script was taken from https://github.com/Lumos-Github/Auto-add-Shadow-Caster-2D-on-TileMap/blob/main/Assets/ShadowCaster2DTileMap.cs
 * and modified by Rehope Games (https://www.youtube.com/watch?v=n3tgimClTrI)
 * This script is used for tooling purposes only, as manually generating Shadow Casters is very time consuming
 */
...
public class AutoShadowCaster2DGenerator : MonoBehaviour
{
	[SerializeField]
...
[CustomEditor(typeof(AutoShadowCaster2DGenerator))]
public class ShadowCaster2DTileMapEditor : Editor
{
	public override void OnInspectorGUI()
	{
		...
		{
			var creator = (AutoShadowCaster2DGenerator)target;
			creator.Create();
		}
